...
#' Examples are ordered by date (from May 2008 to November 2010), similar to data analyzed in [Moro et al., 2014]
#'
#'
...
#'   \item{contact}{contact communication type (categorical: 'cellular','telephone')}
...
#' @source \cite{S. Moro, P. Cortez and P. Rita. A Data-Driven Approach to Predict the Success of Bank Telemarketing. Decision Support Systems, Elsevier, 62:22-31, June 2014}
"bankData"

#' Dummy labels for bankData
#'
#' A dataset containing the attribute labels also found in \code{\link{bankData}}. 
#' This data set is used to illustrate the PrepLabels function and other label 
#' functionality in the otvPlots package in R
#'
#' @format A data frame with 16 rows and 3 variables:
#' \describe{
#'   \item{V1}{name of each variable in bankData}
#'   \item{V2}{label of each variable in bankData}
#'   \item{V3}{a dummy variable, corresponding to the row number}
#'   ...
#' }
"bankLabels"

library(otvPlots)
context("Summary stats for continuous variables")
load("../testthat/testData.rda")
setDT(testData)
suppressMessages(PrepData(testData, dateNm = "date", dateGp = "weeks", dateGpBp = "weeks", weightNm = "weight"))

test_that("Continuous statistics are calculated correctly without weight", {
...
test_that("Continuous statistics are calculated correctly with weight", {
